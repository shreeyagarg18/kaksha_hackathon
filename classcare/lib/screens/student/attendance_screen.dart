          ...
          TextButton(
            onPressed: () async {
              ...
              if (newStatus.isGranted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Bluetooth permission is required to continue.')),
                );
              }
            },
      ...
      body: isCheckingStatus 
          ...
          : Column(
              children: [
                // Status bar
                Container(
                  color: isBluetoothOn ? Colors.green.shade100 : Colors.orange.shade100,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            color: isBluetoothOn ? Colors.green.shade800 : Colors.orange.shade800,
                ...
                Padding(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(isBluetoothOn ? Icons.check_circle : Icons.bluetooth),
                    label: Text(isBluetoothOn ? 'Give Attendance' : 'Enable Bluetooth'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isBluetoothOn ? Colors.blue : Colors.orange,
